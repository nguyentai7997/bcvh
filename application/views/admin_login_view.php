...
<div class="page" data-animsition-in="fade-in" data-animsition-out="fade-out">
	<div class="page-content">
		<div class="page-brand-info">
			<div class="brand">
				<img class="brand-img" src="<?= base_url()?>assets1/images/vietlott_logo.png" title="teemarket">
			</div>
			<p class="font-size-20">Chủ động, sáng tạo, chuyên nghiệp, đoàn kết, trách nhiệm, hiệu quả</p>
		</div>
		...
		<div class="page-login-main">
			...
			<h3 class="font-size-24">Đăng nhập</h3>
			<form action="">
				<div class="form-group form-material floating" data-plugin="formMaterial">
					<input type="email" class="form-control empty" id="inputEmail" name="email">
					<label class="floating-label" for="inputEmail">Tài khoản</label>
				...
				<div class="form-group form-material floating" data-plugin="formMaterial">
					...
					<label class="floating-label" for="inputPassword">Mật khẩu</label>
				...
				<button type="button" class="btn btn-primary btn-block signin">Đăng nhập</button>
			</form>
		</div>
